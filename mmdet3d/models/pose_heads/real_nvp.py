# modified from RLE: https://github.com/Jeff-sjtu/res-loglikelihood-regression
...
class RealNVP(nn.Module):
    def __init__(self):
        ...
        nets = nets3d
        nett = nett3d
        prior = distributions.MultivariateNormal(torch.zeros(3), torch.eye(3))
        mask = torch.from_numpy(np.array([[0, 0, 1], [1, 1, 0]] * 3).astype(np.float32))
        self.prior = prior
